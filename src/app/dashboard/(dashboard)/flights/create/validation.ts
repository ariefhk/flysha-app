...
export const formFligtValidation = z.object({
  airplaneId: z.string({ required_error: "Pesawat tidak boleh kosong" }),
  ...
  departureCityCode: z
    ...
    .min(3, {
      message: "Kode kota keberangkatan harus memiliki panjang minimal 3 karakter",
    })
    .max(3, {
